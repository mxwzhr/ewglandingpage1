      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-600">Emmell Ground Worx provides top-quality excavation and groundwork services for the area of Wilkes County and the  surrounding communities. Our team brings expertise and dedication to every project, no matter the size or complexity.</p>
