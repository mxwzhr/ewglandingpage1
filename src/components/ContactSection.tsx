        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div className="bg-white p-8 rounded-lg shadow-md">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Button 
                type="submit" 
                className="w-full bg-emmell-orange hover:bg-emmell-orange/90 text-white py-6"
              >
                Send Message
              </Button>
            </form>
          ...
          <div className="space-y-8">
            <div className="bg-white p-8 rounded-lg shadow-md space-y-6">
              ...
              <div className="flex items-start space-x-4">
                <MapPin className="text-emmell-orange h-5 w-5 mt-1" />
                <div>
                  <p className="font-medium text-emmell-navy">Address</p>
                  <p className="text-gray-600">123 Construction Way,<br />Anytown, US 12345</p>
                </div>
              </div>
            </div>
